  ...
  return (
    <>
      <div className={main_text_container}>
        <div
          className={`${main_texts} main_texts animate__animated animate__fadeInLeft`}
        >
          <p className={main_title}>Masažo paslaugos</p>
          <p className={main_text}>
            Masažo paslaugos teikiamos profilaktiniais, išvaizdos koregavimo,
            kosmetiniais, celiulito gydymo, skausmų mažinimo ir antistresiniais
            tikslais.
          </p>
          <p className={main_text}>
            Masažo metu naudojami įvairūs efektyvūs šiuolaikinio masažo
            prietaisai, skirti tiksliau dozuoti procedūros intensyvumą kliento
            patogumui.
          </p>
          <p className={main_text}>
